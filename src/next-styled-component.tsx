        ...
        class HTMLElement extends Component<LayoutProps & PseudoSelectorProps & HTMLAttributes<any> & { as?: string, forwardedRef?: ForwardedRef<unknown> }> {
          ...
          render() {
            ...
            return createElement(
              ...
              { className: `${this.props.className || ''} ${cn(test.styleArray.map(([className]) => `${className}`))}`.trim() || false, ref: forwardedRef, ...filteredProps },
              this.props.children
            );
          }
        },
      ...
      return createElement(
        class HTMLElement extends Component<LayoutProps & PseudoSelectorProps & HTMLAttributes<any> & { as?: string, forwardedRef?: ForwardedRef<unknown> }> {
          ...
          render() {
            ...
            return createElement(
              this.props.as || HTMLTag || "div",
              { className: `${this.props.className || ''} jsx-${id}`.trim() || false, ref: forwardedRef, ...filteredProps },
              this.props.children
            );
          }
        },
      ...
      return createElement(
        class HTMLElement extends Component<LayoutProps & PseudoSelectorProps & HTMLAttributes<any> & { as?: string, forwardedRef?: ForwardedRef<unknown> }> {
          ...
          render() {
            ...
            return createElement(
              this.props.as || HTMLTag || "div",
              { className: `${this.props.className || ''} ${this.prevProps[0] === 1 ? className : `${className}-${this.prevProps[0]-1}`}`.trim() || false, ref: forwardedRef, ...filteredProps },
              this.props.children
            );
          }
        },
